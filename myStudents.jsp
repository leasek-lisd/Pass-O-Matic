...
<input type="submit" value="Search">
 ...
 do{  %>
   <tr>
     ...
     <td>
       <div><%=resultSet.getString("firstName")%> (<%=resultSet.getString("goesBy")%>) <%=resultSet.getString("lastName")%> <%
if(resultSet.getString("currentLocation").length() > 0){%>
<span class="tempLocation">  <%=resultSet.getString("currentLocation")%> </span> <%}%>
